...
public class BoardController {
	...
	public String list1(@RequestParam(required = false) String type, @RequestParam(required = false) String keyword,
			@RequestParam(required = false, defaultValue = "1") int p,
			@RequestParam(required = false, defaultValue = "10") int s, Model model) {
...
//	RedirectAttributes를 매개변수에 선언하고 데이터를 Model 처럼 추가하면 파라미터 처리된다
	@PostMapping("/edit")
	public String edit(@ModelAttribute BoardDto boardDto, HttpServletResponse response, RedirectAttributes attr) {
...
//			return "redirect:detail?boardNo="+boardDto.getBoardNo(); 
	...
	public String edit2(@ModelAttribute BoardDto boardDto, @PathVariable int boardNo, RedirectAttributes attr) {
...
//			return "redirect:detail?boardNo="+boardDto.getBoardNo(); 
	...
	@GetMapping("/write")
	public String write(@RequestParam(required = false, defaultValue = "0") int sn, Model model) {
		if (sn > 0) {
	...
	public String write(@ModelAttribute BoardDto boardDto, @RequestParam MultipartFile boardAttachment,
	...
	@PostMapping("/file")
	public String file(@ModelAttribute BoardDto boardDto, @RequestParam MultipartFile boardAttachment,
	...
	public String write1(@RequestParam(required = false, defaultValue = "0") int sn, Model model) {
		if (sn > 0) {
			model.addAttribute("sn", sn);
		}
	...
	public String write1(@ModelAttribute BoardDto boardDto, @RequestParam MultipartFile boardAttachment,
			HttpSession session, RedirectAttributes attr) throws IllegalStateException, IOException {
	...
	public String write2(@ModelAttribute BoardDto boardDto, HttpSession session, RedirectAttributes attr) {
	...
	public String write3(@RequestParam(required = false, defaultValue = "0") int sn, Model model) {
		if (sn > 0) {
			model.addAttribute("sn", sn);
		}
