...
pageEncoding="UTF-8"%>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="footer__widget">
                        ...
                        <div class="footer__widget__social">
                            ...
                            <a href="${root}/"><i class="fa fa-instagram"></i></a>
                            <a href="${root}/"><i class="fa fa-twitter"></i></a>
                            <a href="${root}/"><i class="fa fa-pinterest"></i></a>
                        </div>
                    </div>
                </div>
            </div>
  ...
  Copyright &copy;1998-<script>document.write(new Date().getFullYear());</script> Book Store All Right Reserved
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
                        <div class="footer__copyright__payment"><img src="${pageContext.request.contextPath}/image/kakaopay.png" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
