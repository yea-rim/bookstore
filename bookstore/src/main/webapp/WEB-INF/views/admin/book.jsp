				...
				<div class="row float-container mt-1" id="app">
					...
					<div class="col-lg-6" style="width: 100%; padding: 10px;">
						...
						<div class="row input-group mb-3">
							<span class="input-group-text" id="basic-addon1">ISBN</span> <input
								type="text" class="form-control" placeholder="ISBN을 입력하세요."
								v-model.number="currentData.bookIsbn"
						...
						<div class="row mt-2">
							<img src="https://blog.kakaocdn.net/dn/QvcRL/btrHPfOzHi9/ezKZ0uKRpFOGfgRP0EsgC1/img.png" style="max-width: 95%;">
						</div>
					...
					<div class="col-lg-6" style="width: 100%; padding: 10px;">
						...
						<div class="row input-group mb-3" v-if="isEditMode">
							<span class="input-group-text" id="basic-addon1">도서 번호</span> <input
								type="text" class="form-control" placeholder="도서 번호를 입력하세요."
								aria-describedby="basic-addon1"
								v-model.number="currentData.bookNo" readonly>
						</div>

						<div class="row input-group mb-3">
							<span class="input-group-text" id="basic-addon1">제목</span> <input
								type="text" class="form-control" placeholder="도서 제목을 입력하세요."
								aria-describedby="basic-addon1" v-model="currentData.bookTitle">
						</div>

						<div class="row input-group mb-3">
							<span class="input-group-text" id="basic-addon1">ISBN</span> <input
								type="text" class="form-control" placeholder="ISBN을 입력하세요."
								aria-describedby="basic-addon1" v-model="currentData.bookIsbn">
						</div>
						...
						<div class="row input-group mb-3">
							...
							<img :src="currentData.bookImage"
								onerror="this.src='https://via.placeholder.com/82X121.png?text=book'"
								width="82" height="121" />
						</div>

						<div class="row input-group mb-3">
							<span class="input-group-text" id="basic-addon1">저자</span> <input
								type="text" class="form-control" placeholder="저자 이름을 입력하세요."
								aria-describedby="basic-addon1" v-model="currentData.bookAuth">
						</div>

						<div class="row input-group mb-3">
							<span class="input-group-text" id="basic-addon1">출판사</span> <input
								type="text" class="form-control" placeholder="출판사를 입력하세요."
								aria-describedby="basic-addon1" v-model="currentData.bookPubl">
						</div>

						<div class="row input-group mb-3">
							<span class="input-group-text" id="basic-addon1">출판일</span> <input
								type="text" class="form-control" placeholder="출판일을 입력하세요."
								aria-describedby="basic-addon1" v-model="currentData.bookPub">
						</div>

						<div class="row input-group mb-3">
							<span class="input-group-text" id="basic-addon1">줄거리</span> <input
								type="text" class="form-control" placeholder="줄거리를 입력하세요."
								aria-describedby="basic-addon1"
								v-model="currentData.bookDescription">
						</div>

						<div class="row input-group mb-3">
							<span class="input-group-text" id="basic-addon1">분류</span> <input
								type="text" class="form-control"
								placeholder="옆을 참고하시어 분류를 입력하세요."
								aria-describedby="basic-addon1" v-model="currentData.bookType">
						...
						<table class="table table-border">
							...
							<tbody>
								...
								<tr v-for="(book, index) in bookList" v-bind:key="index">
									<td>{{book.bookNo}}</td>
									<td><img :src="book.bookImage" width="82" height="121" />
									</td>
