...
<div class="container">
	<section class="shoping-cart spad">
		<!-- form(결제구현 )-->
		<form action="${pageContext.request.contextPath }/pay/purchase"
			method="get">
			<div class="row">
				<div class="col-lg-8">
								...
								<tbody>
									<tr style="border-bottom: none;">
										...
										<td class="col-lg-9"><input type="text"
											...
											&nbsp;
											<button v-on:click="readMember"
												style="border: none; background: #F09F00; color: #ffffff; height: 30px;">내정보</button>
							...
							<table>
								...
								<tbody>
									...
									<c:if test="${storeAmount>0}">
										<input type="hidden" name="finalStore[${0 }].storeBookNo"
											value="${storeDto.storeBookNo }">
										<input type="hidden" name="finalStore[${0 }].quantity"
											value="${storeAmount }">

										<tr>
											<td class="shoping__cart__item"><img
												src="${storeDto.bookImage }"></td>
											<td style="text-align: left">
												<h5>${storeDto.bookTitle }</h5>
											</td>
											<td class="shoping__cart__price">${storeDto.storePrice }원
											</td>
											<td class="shoping__cart__quantity">
												<h5>${storeAmount }개</h5> <!--                                         <div class="quantity"> -->
												<!--                                             <div class="pro-qty"> -->
												<!--                                                 <input type="text" value="1"> -->
												<!--                                             </div> -->
												<!--                                         </div> -->
											</td>
											<td class="shoping__cart__total">${storeDto.storePrice * storeAmount}원
											</td>
									...
									<c:forEach var="usedDto" items="${usedList }"
										varStatus="status">
										<input type="hidden" name="finalUsed[${status.index }].usedNo"
											value="${usedDto.usedNo }">
										<tr>
											<td class="shoping__cart__item"><img
												src="${usedDto.bookImage }"></td>
											<td style="text-align: left">
												<h5>${usedDto.bookTitle }</h5>
											</td>
											<td class="shoping__cart__price">${usedDto.usedPrice }원
											</td>
											<td class="shoping__cart__quantity">
												<h5>1개</h5> <!--                                         <div class="quantity"> -->
												<!--                                             <div class="pro-qty"> -->
												<!--                                                 <input type="text" value="1"> -->
												<!--                                             </div> -->
												<!--                                         </div> -->
											</td>
											<td class="shoping__cart__total">${usedDto.usedPrice }원
											</td>
											<td class="shoping__cart__item__close"><span
												class="icon_close"></span></td>
										</tr>
