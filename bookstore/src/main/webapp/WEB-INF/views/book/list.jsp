                  ...
                  <tbody>
                     <tr>
                        ...
                        <td style="text-align: left">
                           <h4 class="m-3"><a href="${root}/book/detail?bookNo=${bookDto.bookNo}">${bookDto.bookTitle}</a></h4>
                           <h6 class="m-3">${bookDto.bookDescription}</h6>
                        </td>
                        <td class="text-center">
                           <button class="btn site-btn m-2">장바구니</button>
                           <button class="btn site-btn m-2">구매</button>
                        </td>
                     </tr>
                  </tbody>
               </c:forEach>
